...
public class SkeletonSpawnEvent 
{
	...
	public void createMonster()
	{
		...
		{
			ItemStack inhand = Tools.setItemDisplayName(new ItemStack(Material.FLINT_AND_STEEL),ChatColor.DARK_RED + "Pirate Flint");
		...
		{
			ItemStack inhand = Tools.setItemDisplayName(new ItemStack(Material.SKULL_ITEM),ChatColor.DARK_RED + "Scourge");
		...
		{
			ItemStack inhand = Tools.setItemDisplayName(new ItemStack(Material.BONE),ChatColor.DARK_RED + "Zwei Bone of Ra");
		...
		{
			ItemStack inhand = Tools.setItemDisplayName(new ItemStack(Material.FISHING_ROD),ChatColor.DARK_RED + "Rod of Prophecy");
		...
		else if(mobName.equalsIgnoreCase("Sumo Skeleton"))
		{
			...
			ee.setItemInHand(inhand);
			ItemStack helm = Tools.setItemDisplayName(new ItemStack(Material.LEATHER_HELMET),ChatColor.AQUA + "Sky Cap");
		...
		else if(mobName.equalsIgnoreCase("Flayed"))
		{
			...
			//Fire bow
			ItemStack bow = Tools.setItemDisplayName(new ItemStack(Material.BOW),ChatColor.DARK_GRAY + "Flay them Living!");
		...
		else if(mobName.equalsIgnoreCase("Death Knight"))
		{
			...
			//Fire bow
			ItemStack inhand = Tools.setItemDisplayName(new ItemStack(Material.BOW),ChatColor.DARK_GRAY + "Raining " + ChatColor.RED + "Death");
		...
		{
			lent.addPotionEffect(new PotionEffect(PotionEffectType.SPEED,MonsterListener.POTION_DURATION,1));
			ItemStack inhand = Tools.setItemDisplayName(new ItemStack(Material.DIAMOND_PICKAXE),ChatColor.DARK_AQUA + "War Pick");
			inhand.addUnsafeEnchantment(Enchantment.DAMAGE_ALL, 2);
			inhand.addUnsafeEnchantment(Enchantment.FIRE_ASPECT, 1);
			inhand.addUnsafeEnchantment(Enchantment.DURABILITY, 2);
		...
		{
			ItemStack inhand = Tools.setItemDisplayName(new ItemStack(Material.IRON_AXE),ChatColor.DARK_AQUA + "The Chiller");
			inhand.addUnsafeEnchantment(Enchantment.DAMAGE_ALL, 3);
		...
		{
			ItemStack inhand = Tools.setItemDisplayName(new ItemStack(Material.ANVIL),ChatColor.DARK_AQUA + "Worthy Anvil");
		...
		{
			ItemStack inhand = Tools.setItemDisplayName(new ItemStack(Material.CACTUS),ChatColor.DARK_AQUA + "Crazy Cactus");
			inhand.addUnsafeEnchantment(Enchantment.DAMAGE_ARTHROPODS, 3);
		...
		else if(mobName.equalsIgnoreCase("Executioner"))
		{
			...
			ItemStack inhand = Tools.setItemDisplayName(new ItemStack(Material.DIAMOND_AXE),ChatColor.DARK_AQUA + "The Beheader");
			inhand.addUnsafeEnchantment(Enchantment.DAMAGE_ALL, 3);
			inhand.addUnsafeEnchantment(Enchantment.DAMAGE_ARTHROPODS, 2);
			inhand.addUnsafeEnchantment(Enchantment.DAMAGE_UNDEAD, 2);
			inhand.addUnsafeEnchantment(Enchantment.DURABILITY, 2);
