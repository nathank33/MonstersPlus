...
import me.coolade.jobsplus.customitems.CustomItems.CustomItemSet;
...
public class CustomShapelessRecipes 
{
	public static ArrayList<CustomShapelessRecipe> recipes = new ArrayList<CustomShapelessRecipe>(){{
		//add(new CustomShapelessRecipe("Bacon",Material.PORK,new String[]{"Ribs","Turkey"}));
	...
	public CustomShapelessRecipes()
	{
		...
		for(CustomShapelessRecipe crecipe : recipes)
		{
			item = new ItemStack(crecipe.getMat(), crecipe.getAmount(), crecipe.getDurability());
			ItemMeta meta = item.getItemMeta();
			meta.setDisplayName(crecipe.getName());
			item.setItemMeta(meta);
			
			recipe = new ShapelessRecipe(item);
			String[] ingredients = crecipe.getIngredients();
			for(String s : ingredients)
			{
				CustomItemSet cis = CustomItems.getCustomItem(s);
				recipe.addIngredient(cis.getMat());
			}
	...
	public static class CustomShapelessRecipe
	{
		...
		String displayName;
		String description;
		public CustomShapelessRecipe(String name, Material mat, int amount, short durability,
				String[] ingredients, String displayName, String description)
		{
			this.name = name;
			this.mat = mat;
			this.amount = amount;
