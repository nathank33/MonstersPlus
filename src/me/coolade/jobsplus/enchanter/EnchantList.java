...
{	public static final int LVLCOST1 = 10;
	...
	public static final ArrayList<EnchantRecipe> ENCHANTLIST = new ArrayList<EnchantRecipe>(){{
		...
		add(new EnchantRecipe(Enchantment.PROTECTION_PROJECTILE,"ProjectileProtection",2,"Enchanter",3,LVLCOST2));
		...
		add(new EnchantRecipe(Enchantment.PROTECTION_PROJECTILE,"ProjectileProtection",2,"Enchanter",5,LVLCOST2));
