...
{
	private ArrayList<EnchantmentSet> enchantmentList = new ArrayList<EnchantmentSet>(){};
	
	public CustomEnchantment()
	{		
		/**
		 * The list of all the custom enchantments that have been added into the game.
		 */
		enchantmentList.add(new EnchantmentSet("Ice Aspect", 	2,	"Warrior",	new int[]{7,16},
				new int[]{30,30},	new int[]{4,8},	EnchantableItems.MELEE, new String[]{"None"}, 
		...
		enchantmentList.add(new EnchantmentSet("Wither Aspect", 	2,	"Warrior",	new int[]{5,15},
				new int[]{30,30},	new int[]{4,8},	EnchantableItems.MELEE, new String[]{"Toxic Aspect"}, 
		...
		enchantmentList.add(new EnchantmentSet("Life Shot",	2,	"Survivalist",	new int[]{8,18},
				new int[]{30,35},	new int[]{4,8},	EnchantableItems.BOW, new String[]{"None"}, 
				"Has a chance to steal health on every hit. (Bows)"));
		
		enchantmentList.add(new EnchantmentSet("Ice Shot", 	2,	"Survivalist",	new int[]{7,16},
				new int[]{30,30},	new int[]{4,8},	EnchantableItems.BOW, new String[]{"None"}, 
		...
		enchantmentList.add(new EnchantmentSet("Molten Shell", 	2,	"Blacksmith",	new int[]{2,10},
				new int[]{20,20},	new int[]{2,4},	EnchantableItems.ARMOR, new String[]{"Wither Shell", "Poison Shell"}, 
				"A chance that the attacker will catch on fire. (Armor)"));
		enchantmentList.add(new EnchantmentSet("Wither Shell", 	2,	"Blacksmith",	new int[]{6,14},
				new int[]{20,20},	new int[]{2,4},	EnchantableItems.ARMOR, new String[]{"Molten Shell", "Poison Shell"}, 
				"A chance that the attacker will suffer from Wither. (Armor)"));
		enchantmentList.add(new EnchantmentSet("Poison Shell", 	2,	"Blacksmith",	new int[]{8,20},
				new int[]{20,20},	new int[]{2,4},	EnchantableItems.ARMOR, new String[]{"Molten Shell", "Wither Shell"}, 
		...
		enchantmentList.add(new EnchantmentSet("Poverty Barrier", 	2,	"Blacksmith",	new int[]{3,11},
				new int[]{20,20},	new int[]{2,4},	EnchantableItems.ARMOR, new String[]{"Confusing Barrier", "Blinding Barrier"}, 
		...
		enchantmentList.add(new EnchantmentSet("Confusing Barrier", 	2,	"Blacksmith",	new int[]{4,12},
				new int[]{20,20},	new int[]{2,4},	EnchantableItems.ARMOR, new String[]{"Poverty Barrier", "Blinding Barrier"}, 
		...
		enchantmentList.add(new EnchantmentSet("Blinding Barrier", 	2,	"Blacksmith",	new int[]{9,22},
				new int[]{20,20},	new int[]{2,4},	EnchantableItems.ARMOR, new String[]{"Poverty Barrier", "Confusing Barrier"}, 
				"A chance that the attacker will suffer from Blindness. (Armor)"));
		
		enchantmentList.add(new EnchantmentSet("Regeneration Aura", 	2,	"Blacksmith",	new int[]{5,13},
				new int[]{20,20},	new int[]{2,4},	EnchantableItems.ARMOR, new String[]{"Health Aura", "Berserk Aura"}, 
		...
		enchantmentList.add(new EnchantmentSet("Health Aura", 	2,	"Blacksmith",	new int[]{7,15},
				new int[]{20,20},	new int[]{2,4},	EnchantableItems.ARMOR, new String[]{"Regeneration Aura", "Berserk Aura"}, 
				"When attacked you have a chance to gain bonus health. (Armor)"));
		enchantmentList.add(new EnchantmentSet("Berserk Aura", 	2,	"Blacksmith",	new int[]{8,18},
				new int[]{20,20},	new int[]{2,4},	EnchantableItems.ARMOR, new String[]{"Regeneration Aura", "Health Aura"}, 
		...
		enchantmentList.add(new EnchantmentSet("Sharp Hook", 5,	"Fisherman",	new int[]{3,5,9,13,19},
				new int[]{8,20,30,15,30},	new int[]{0,0,0,2,4},	EnchantableItems.FISHINGROD, new String[]{"None"}, 
				"Increases damage (Fishing Rod)"));
		
		enchantmentList.add(new EnchantmentSet("Molten Hook", 1,	"Fisherman",	new int[]{7},
				new int[]{10},	new int[]{1},	EnchantableItems.FISHINGROD, new String[]{"Silk Hook"}, 
				"Smelts or Cooks the items (Fishing Rod)"));
		
		enchantmentList.add(new EnchantmentSet("Silk Hook", 1,	"Fisherman",	new int[]{11},
				new int[]{15},	new int[]{1},	EnchantableItems.FISHINGROD, new String[]{"Molten Hook"}, 
				"Causes Silktouch to any item caught."));
		
		
		
		enchantmentList.add(new EnchantmentSet("Molten Touch", 1,	"Miner",	new int[]{5},
				new int[]{15},	new int[]{1},	EnchantableItems.TOOLS, new String[]{"LOOT_BONUS_BLOCKS"}, 
		...
		enchantmentList.add(new EnchantmentSet("Lucky Break", 4,	"Miner",	new int[]{3,6,10,15},
				new int[]{20,25,30,30},	new int[]{1,2,4,6},	EnchantableItems.PICKAXES, new String[]{"None"}, 
				"Grants additional experience orbs when mining (Pickaxes)"));
		enchantmentList.add(new EnchantmentSet("Smash", 3,	"Miner",	new int[]{4,12,18},
				new int[]{20,30,30},	new int[]{0,2,4},	EnchantableItems.PICKAXES, new String[]{"None"}, 
		...
		enchantmentList.add(new EnchantmentSet("Dazzle", 1,	"Farmer",	new int[]{7},
				new int[]{30},	new int[]{1},	EnchantableItems.SHEARS, new String[]{"None"}, 
				"Randomly changes the color of wool (Shears)"));
		
		enchantmentList.add(new EnchantmentSet("Papercut", 1,	"Farmer",	new int[]{9},
				new int[]{15},	new int[]{1},	EnchantableItems.SHEARS, new String[]{"None"}, 
		...
		enchantmentList.add(new EnchantmentSet("Tilling", 5,	"Farmer",	new int[]{3,6,10,14,18},
				new int[]{15,25,20,30,30},	new int[]{0,0,2,4,6},	EnchantableItems.HOES, new String[]{"None"}, 
				"Tills larger areas (Your Mom, aka hoes)"));
		
		enchantmentList.add(new EnchantmentSet("Hydration", 5,	"Farmer",	new int[]{3,5,9,15,25},
				new int[]{15,25,20,30,30},	new int[]{0,0,2,4,6},	EnchantableItems.HOES, new String[]{"None"}, 
				"Hydrate soil in a large radius (Your Mom, aka hoes)"));
		...
		enchantmentList.add(new EnchantmentSet("Puberty", 1 ,	"Farmer",	new int[]{10},
				new int[]{20},	new int[]{2},	EnchantableItems.TOOLS, new String[]{"None"}, 
		...
		enchantmentList.add(new EnchantmentSet("Blackhole", 1,	"Builder",	new int[]{7},
				new int[]{0},	new int[]{2},	EnchantableItems.EMPTYBUCKET, new String[]{"Flow"}, 
				"A bucket that can never be filled (Empty Bucket)"));
		
		enchantmentList.add(new EnchantmentSet("Flow", 1,	"Builder",	new int[]{12},
				new int[]{0},	new int[]{2},	EnchantableItems.WATERBUCKET, new String[]{"Blackhole"}, 
	...
	public ArrayList<EnchantmentSet> getEnchantmentList(){
		/**
		 * Returns the entire list of enchantments that have been added into the game
		 */
	...
	{
		/**
		 * Returns a specific enchantmentSet from the enchantment list based on the name of the eset.
		 */
	...
	public boolean isValidEnchantType(ItemStack item, EnchantmentSet eset)
	{
		...
		/**
		 * Checks to see if the ItemStack is valid for a specific enchantmentSet,
		 * this can be based on if the enchantment is meant for armor, tools, weapons, etc.
		 */
		...
		for(int i = 0; i < validItems.length; i++)
		{
			...
			//if(tempMat == null)
			//	Bukkit.broadcastMessage("isValidEnchantItem could not find: " + validItems[i]);
	...
	{
		/**
		 * Checks an ItemStack to make sure that it does not have any conflicting enchantments
		 * with a specific enchantmentSet.
		 */
	...
	{
		/**
		 * This method returns all of the enchantments on a specific item,
		 * It returns it as a map with enchantments, and the rank of the enchantment
		 * UNTESTED: NEEDS A CHECK based on if the enchantment has a hidden color code.
		 */
		...
		for(String s : lore)
		{
			//Strip apart the string so that we can get the enchantment and its roman numeral rank
	...
	public ItemStack addCustomEnchantment(ItemStack istack, String enchName, int rank)
	{
		 ...
		 */
		if(istack == null || istack.getType() == Material.AIR) return null;
		...
		{
			//If there are no enchantments on the item, then we add this custom glow effect.
	...
	{
		/**
		 * Removes a custom enchantment from an item, returns true if the enchantment was removed.
		 */
		if(istack == null || istack.getType() == Material.AIR 
				|| !istack.hasItemMeta() || !istack.getItemMeta().hasLore()) return false;
	...
	public class EnchantmentSet
	{
		...
		public EnchantmentSet(String name, int maxLevel, String jobName, int[] jobLevels, int[] expsRequired, int[] powerstones, String[] validItems, String[] conflictingEnchantments, String description)
		{
			this.name = name;
		...
		public EnchantmentSet(String name, int maxLevel, String jobName, int[] jobLevels, int[] expRequired, int[] powerstones, String description)
		{
	...
	{
		/**
		 * Represents a customenchantment on a specific item, holds the Custom enchantment as
		 * an EnchantmentSet and holds the rank of the enchantment on the item as Rank.
		 */
	...
	public List<EnchantmentSetOnItem> combineSimilarEnchantments(ItemStack[] items)
	{
		...
		for(ItemStack item : items)
		{
			...
			/*
			 * Cycle through all of the enchantments on this specific item
			 * Cycle through all of the enchantments that have been added into the total,
			 * if it has been added to the total already then we need to update the totals rank.
			 * If it has not been added then we need to add it with this rank.
			 */
			...
			for(int i = 0; i < tempEnchs.size(); i++)
			{
				...
				for(int j = 0; j < totalEnchs.size(); j++)
				{
					...
					if(tempEnch.getEnchantmentSet().getName().equals(totalEnch.getEnchantmentSet().getName()))
					{
						...
						addToList = false; //Since we found a match we don't need to add it to the list, it is already there
					}
				}
				if(addToList)
