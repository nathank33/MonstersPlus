...
public class CustomRecipes 
{
	public static final ArrayList<RecipeSet> arrowList = new ArrayList<RecipeSet>(){{
		...
		add(new RecipeSet("Lasso Arrow",	"Survivalist",4,	"Teleports the enemy to your location, great against players running away.",
		...
		add(new RecipeSet("Grapple Arrow",	"Survivalist",10,	"Teleports the shooter to the arrow location, Hold Crouch to latch onto objects.",
															"2. Lead  5. Stick  8. Feather"));
		add(new RecipeSet("Blizzard Arrow",	"Survivalist",11,	"Causes all nearby enemies to suffer from intense slow.",
		...
		add(new RecipeSet("Shreading Arrow","Warrior",11,	"Does 3% of the targets current HP, great against Legendaries.",
	...
	public static final ArrayList<RecipeSet> builderList = new ArrayList<RecipeSet>(){{
		...
		add(new RecipeSet("Bat Spawner","Builder",4, "Bat Spawner",
				"1-4. Coal 5. MobSpawner  6-9. Coal",									6));
		...
		add(new RecipeSet("Cracked Stone Brick","Builder",2, "Cracked Stone Brick",
				"1. Stone Brick 2. Flint"));
	...
	public static final ArrayList<RecipeSet> farmerList = new ArrayList<RecipeSet>(){{
		add(new RecipeSet("Chicken","Farmer",2,"Chicken Spawn Egg",
				"1-4. Seeds 5. Egg  6-9. Seeds"));
		add(new RecipeSet("Cow","Farmer",3,"Cow Spawn Egg",
				"1-4. Wheat 5. Egg  6-9. Wheat"));
		add(new RecipeSet("Pig","Farmer",4,"Pig Spawn Egg",
				"1-4. Carrot 5. Egg  6-9. Carrot"));
		add(new RecipeSet("Sheep","Farmer",5,"Sheep Spawn Egg",
				"1-4. Wool 5. Egg  6-9. Wool"));
		add(new RecipeSet("Squid","Farmer",5,"Squid Spawn Egg",
				"1-4. Inksac 5. Egg  6-9. Inksac"));
		add(new RecipeSet("Wolf","Farmer",6,"Wolf Spawn Egg",
				"1-4. Bone 5. Egg  6-9. Melon Seeds"));
		add(new RecipeSet("Ocelot","Farmer",8,"Ocelot Spawn Egg",
				"1-4. Milk 5. Egg  6-9. Milk"));
		...
		add(new RecipeSet("Horse","Farmer",15,"Horse Spawn Egg",
				"1-4. Lead 5. Egg  6-9. Lead"));
		add(new RecipeSet("Villager","Farmer",18,"Villager Spawn Egg",
				"1-4. Emerald 5. Egg 6-9. Emerald"));
		
		add(new RecipeSet("Saddle","Farmer",3,"Saddle",
				"1-4. Leather 5. String 6. Leather"));
		add(new RecipeSet("Iron Horse Armor","Farmer",6,"Iron Horse Armor",
				"3-5. Iron Ingot 7-8. Iron Ingot"));
		add(new RecipeSet("Golden Horse Armor","Farmer",10,"Golden Horse Armor",
				"3-5. Gold Ingot 7-8. Gold Ingot"));
		add(new RecipeSet("Diamond Horse Armor","Farmer",14,"Diamond Horse Armor",
				"3-5. Diamond 7-8. Diamond"));
	}};
	public static final ArrayList<RecipeSet> bombList = new ArrayList<RecipeSet>(){{
		...
		add(new RecipeSet("Warrior Bomb",		"Warrior",		10,	"A fire bomb that ignites nearby targets and spawns a temporary " +
				"powerful Zombie Pigman that will attack the nearest entity.",
				"1. Gunpowder  2. Iron Sword  3-4. Gunpowder 5. Egg  6-9. Gunpowder"));
		add(new RecipeSet("WitchDoctor Bomb",	"WitchDoctor",	10,	"A Wither bomb that withers nearby foes and spawns temporary wither skeletons.",
		...
		add(new RecipeSet("Blacksmith Bomb",	"Blacksmith",	10,	"A bomb that summons anvils from the sky to crush foes.",
				"1. Gunpowder  2. Furnace   3-4. Gunpowder 5. Egg  6-9. Gunpowder"));
	}};
	public CustomRecipes()
	{
		/*
		 * Add the "Unique" To the lore so that we know this item was created from the server
		 * and not just renamed.
		 */
	...
	public static class RecipeSet
	{
		...
		public RecipeSet(String name, String job, int level, String description, String recipeDescription, int powerstones)
		{
			this.name = name;
			this.job = job;
			this.level = level;
