...
{
	/*
	 * Instead of using a field lent, we want to directly pass the lent that was sent to us,
	 * that way if it came through a command it would be able to modify the original lent, not a copy
	 * reference.
	 */
	LivingEntity lent;
	String mobName;
	...
	public void createMonster()
	{
		...
		else if(mobName.equalsIgnoreCase("Infearno"))
		{
			...
			newLent.addPotionEffect(new PotionEffect(PotionEffectType.FIRE_RESISTANCE,MonsterListener.POTION_DURATION,50));
			lent = newLent;
		}
		/**  Hadamard    Legendary  **/
		...
		{	
			lent.addPotionEffect(new PotionEffect(PotionEffectType.FIRE_RESISTANCE,MonsterListener.POTION_DURATION,2));
			lent.addPotionEffect(new PotionEffect(PotionEffectType.SPEED,MonsterListener.POTION_DURATION,1));   		
		}
		/**  Arachne    Legendary  **/
