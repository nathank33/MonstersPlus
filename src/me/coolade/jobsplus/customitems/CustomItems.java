...
public class CustomItems
{
	...
	{
		if(s == null || item == null || !item.hasItemMeta()) return false;
	...
	public static boolean isCustomItem(ItemStack istack)
	{
		...
		{
			if(!istack.getItemMeta().hasDisplayName()) return false;
	...
	/*public static boolean isCustomItem(String s, ItemStack item)
	{
		 ...
		 * same name as s.
		 */
		/*if(s == null || item == null || !item.hasItemMeta() || !item.getItemMeta().hasDisplayName()) return false;
		
		ItemMeta meta = item.getItemMeta();		
		String itemName = ChatColor.stripColor(meta.getDisplayName());
		if(itemName != null && CustomItems.isCustomItem(itemName))
		{
			if(itemName.equalsIgnoreCase(ChatColor.stripColor(s)))
				return true;
		}
		return false;
	}
	...
	public static ItemStack createCustomItem(String name, int amount)
	{
		...
		if(cis != null)
		{
			...
			meta.setLore(new ArrayList<String>(){{add(ChatColor.DARK_PURPLE + "Unique");}});
